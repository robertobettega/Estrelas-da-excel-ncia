...
<head>
    ...
    <style>
    /* .select-container {
            display: flex; /* Usa flexbox para alinhar os selects lado a lado */
    } */
    </style>
</head>
<body>
...
<!-- <div class="container select-container">
    <h3>Qualidade:</h3>
    <select>
            <option value="" disabled selected>Selecione uma qualidade</option>
            <option value="Hospitalidade">Hospitalidade</option>
            <option value="Prestreza">Prestreza</option>
