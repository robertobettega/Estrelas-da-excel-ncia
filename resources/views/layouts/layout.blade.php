        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="row row-cols-1 row-cols-md-2 g-4">
                        ...
                        <div class="col">
                            <figure class="text-center">
                                ...
                                <p style="font-style: italic;font-weight:normal;">{{ $pillar['description'] }}</p>
                ...
                <div style="text-align: center; padding: 20px; border-radius: 8px; margin: 20px auto; max-width: 1000px; background-color: #f8f9fa; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                    <h3 style="font-size: 1.5em; margin-bottom: 20px; color: #13743C;">Passos para dedicar uma estrela:</h3>
                    <ul style="list-style: none; padding: 0; margin: 0; text-align: left; display: inline-block; width: 100%; font-weight:normal;">
